...
$(document).ready(function(){
	...
	var doc_types = ['Note', 'Receipt', 'Page', 'Form', 'Business card', 'CV', 'Letter'];
	var orientations = ['up', 'left', 'down', 'right'];
	var bb_names = ['Document', 'Image', 'Text', 'Table', 'Drawing', 'Diagram', 'Title', 'Subtitle', 'Underlined text', 'Line', 'Checkbox', 'Text entry', 'List', 'Math', 'Contact', 'Plot', 'Signature', 'Other'];
	var bbs_colors = ['white', 'orange', 'pink', 'salmon', 'blue', 'brown', 'lime', 'Maroon', 'green', 'DarkGreen', 'LightSlateGrey', 'yellow', 'beige', 'purple', 'DeepPink', 'DarkTurquoise', 'chocolate', 'papayawhip'];
