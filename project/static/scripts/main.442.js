...
$(document).ready(function(){
	...
	var doc_types = ['Form', 'Receipt', 'Page', 'Note', 'Invoice', 'Letter', 'Business card', 'CV'];
	var orientations = ['up', 'left', 'down', 'right'];
	var bb_names = ['Document', 'Image', 'Text', 'Striked-out', 'Table', 'Drawing', 'Diagram', 'Title', 'Subtitle', 'Underlined text', 'Line', 'Checkbox', 'Text entry', 'List', 'Math', 'Contact', 'Plot', 'Signature', 'Other'];
	var bbs_colors = ['white', 'orange', 'pink', 'salmon', 'blue', 'brown', 'lime', 'Maroon', 'green', 'DarkGreen', 'indigo', 'LightSlateGrey', 'yellow', 'beige', 'purple', 'DeepPink', 'DarkTurquoise', 'chocolate', 'papayawhip'];
